      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 shrink-0">
          <button
            ...
            className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold px-4 py-2 rounded-xl shadow-3xs transition-all cursor-pointer"
          >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full border border-slate-200 rounded-xl p-3 text-xs sm:text-sm font-medium bg-slate-50 hover:bg-slate-100 focus:outline-none transition-colors cursor-pointer"
              >
                {subjectList.map((sub) => (
            ...
            <button
              onClick={handleAssemble}
              className="w-full inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white font-bold text-xs sm:text-sm py-3 rounded-xl transition-all cursor-pointer shadow-3xs"
            >
